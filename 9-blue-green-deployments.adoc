...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/blue_green_deployment.png[image]
...
....
$ oc expose service blue --hostname=bluegreen.UserName.{{APPS_ADDRESS}} --name=bluegreen
....
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/blue_deployment.jpeg[image]
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/blue_green_active_green.png[image]
...
spec:
  host: bluegreen.UserName.{{APPS_ADDRESS}}
  port:
    targetPort: "8080"
  to:
    kind: Service
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/bg-routes-page.png[image]
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/bg-edit-route.png[image]

Next, tick on `Split traffic across multiple services`

image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/bg-slipt-traffic.png[image]
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/bg-5050-split.png[image]

Once you click on *Save*; you should see this on the Route Overview page.

image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/bg-route-split-overview.png[image]
