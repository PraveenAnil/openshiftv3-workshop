...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/scale_updown_overview.png[image]
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/scale_updown_overview_scaled.png[image]

*Note:* You can also scale up and down from the web console by going to
the project overview page and clicking twice on
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/scale_up.jpg[image] right next to the pod count circle to
add 2 more pods.
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/idled_pods.jpeg[image]
...
image:https://raw.githubusercontent.com/PraveenAnil/openshiftv3-workshop/3.10/images/scale_down.jpg[image] twice to remove 2 running pods.
